...
import org.example.springboard.dto.UpdateArticleRequest;
...
class BlogApiControllerTest {
    ...
    public void findArticle() throws Exception{
        ...
        Article savedfArticle = blogRepository.save(Article.builder()
                .title(title)
                .content(content)
                .build());

        final ResultActions resultActions = mockMvc.perform(get(url, savedfArticle.getId()));
